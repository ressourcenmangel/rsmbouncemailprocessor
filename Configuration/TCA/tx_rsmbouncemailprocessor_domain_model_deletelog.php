...
return [
    ...
    'types' => [
        '1' => ['showitem' => 'email,deletetime,origuid,origpid,reasontext,reasonvalue, --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:language, sys_language_uid, l10n_parent, l10n_diffsource, --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:access'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => false,
        ...
        'origuid' => [
            'label' => 'LLL:EXT:rsmbouncemailprocessor/Resources/Private/Language/locallang_db.xlf:tx_rsmbouncemailprocessor_domain_model_deletelog.origuid',
            'exclude' => false,
            'config' => [
                'type' => 'input',
                'size' => '10',
